---
id: 5
title: Debug FastAPI Backend Local Deployment
stage: red
date: 2025-12-05
surface: agent
...
user: Abdul Rafay
command: /sp.phr
labels: ["debugging", "fastapi", "vercel", "local-development", "curl", "uvicorn", "powershell", "execution-policy", "routing", "virtualenv"]
links:
...
tests:
 ...
 - Running api/scripts/index_textbook.py
 - Manual verification of uvicorn server startup
---
...
- **Failure modes observed:** Specify any issues encountered, such as ambiguous instructions, incomplete metadata, misrouted commands, or unexpected script errors. Example: "Prompt did not capture full user input; metadata field 'LABELS' was blank."
